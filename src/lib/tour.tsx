...
export type PersonaKey = "manager" | "coach" | "parent" | "student";
...
export const TOUR_STEPS: TourStep[] = [
  ...
  // ═══ Act 1 · Club Manager ═══
  {
    ...
    body: "Nadeesha runs the whole club from here — today's sessions, coaches on deck, swimmers present and anything needing attention.",
    placement: "center",
  },
  {
  ...
  },
  {
    ...
    action: seq(
      click("new-lead-btn"),
      w(500),
      type("lead-name", "Ishara Madushani"),
      type("lead-phone", "+94 77 123 4567"),
  ...
  // ═══ Act 2 · Swim Coach ═══
  {
    ...
    body: "Signed in as Coach Mariana. Least-privilege: she only sees her own sessions and swimmers, nothing else in the club.",
    placement: "center",
  },
  {
    id: "coach-timetable",
    ...
    body: "Only Mariana's sessions. Let's open one and run it poolside.",
  },
  {
    id: "coach-attend",
    act: "Act 2 · Swim Coach",
  ...
  // ═══ Act 3 · Parent ═══
  {
    ...
    body: "Signed in as Nimal, dad of Aarav and Tashi. One login, only his own children — across every institute they attend.",
    placement: "center",
  },
  {
    id: "parent-records",
  ...
  },
  {
    ...
    body: "Real, persisted two-way messaging — an absence note or a quick question, shared with the coach.",
    action: seq(
      type(
        "msg-input",
        "Hi Coach — Aarav has a dentist appointment Saturday, he'll be 15 min late.",
      ),
      w(400),
      click("msg-send"),
    ),
  ...
  // ═══ Wrap-up ═══
  {
    ...
    body: "One platform for registration, coaching, competition, safeguarding, fees and family communication — with one login per family. That's 1StudentID. Thank you!",
    placement: "center",
    autoMs: 12000,
  },
];
